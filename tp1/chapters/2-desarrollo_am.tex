...
En el Punto de Medición A se observa la señal de AM obtenida al sumar la portadora al producto de la modulante
por la portadora.

\begin{figure}[!ht]
    \centering
    % Espacio reservado para las capturas que subirá el usuario
    \vspace{6cm} 
    \caption{Señal AM en el dominio del tiempo (Punto A) con $m = 1$.}
    \label{fig.am:puntoA_tiempo}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \vspace{6cm}
    \caption{Señal en el dominio del tiempo y frecuencia en la salida del mezclador (Punto B).}
    \label{fig.am:puntoB}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \vspace{6cm}
    \caption{Señal filtrada en Frecuencia Intermedia (Punto C).}
    \label{fig.am:puntoC}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \vspace{6cm}
    \caption{Señales demoduladas: sincrónica (Punto D) y asincrónica (Punto E).}
